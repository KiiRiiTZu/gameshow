...
export async function exportEncryptionPublicKey(publicKey) {
  return crypto.subtle.exportKey("jwk", publicKey);
}

export async function encryptPrivatePayload(publicKeyData, payload) {
...
export async function decryptPrivatePayload(privateKey, encryptedPayload) {
